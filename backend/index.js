...
app.post("/add/item", addItem) //ig gets called when we hit ADD button (which may have a POST method in the front end or something like that)

//this function takes in the attributes that get sent with the POST form and turns them into a json object to store
